...
Your `party_id` is visible in the admin panel at **[Admin → Organizations](/docs/en/admin/parties)**.
...
See [API Overview](/docs/en/api/overview) for the complete filtering guide.
...
- [API Overview](/docs/en/api/overview) — how to connect your eshop to the API
- [Role Hierarchy](/docs/en/users/roles) — Owner, Admin, Eshop Admin and their scopes
- [Permissions System](/docs/en/users/permissions) — which permission bits control which features
- [Environment Setup](/docs/en/getting-started/environment) — where to find your project ref, anon key, and party_id
