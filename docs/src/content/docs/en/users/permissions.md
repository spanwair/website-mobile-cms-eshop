...
1. Go to **[Admin → Roles](/docs/en/admin/roles)**
2. Click **New Role**
3. Give it a name (e.g. "Order Manager") and an optional description
4. Tick the permissions this role should have
5. Save — the role is now selectable when inviting members at **[Admin → Organizations](/docs/en/admin/parties)**
...
- [Role Hierarchy](/docs/en/users/roles) — how Owner, Admin, Eshop Admin and User relate to each other
- [Roles (admin page)](/docs/en/admin/roles) — create and manage custom roles
- [Users (admin page)](/docs/en/admin/users) — assign roles to users in your organization
