...
- Name: 27-cms-navigation-url-combobox.spec.ts >> CMS Navigation URL Combobox >> always shows "Add new" and handles URL normalization
- Location: tests/e2e/27-cms-navigation-url-combobox.spec.ts:4:3
...
Call log:
  - waiting for locator('form.nav-form .combobox').first().locator('.combobox-input')
